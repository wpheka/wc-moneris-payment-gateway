 ...
 */
define( 'WPHEKA_MONERIS_VERSION', '1.9' );
...
define( 'WPHEKA_MONERIS_PLUGIN_LOGO', untrailingslashit( plugins_url( '/assets/images/wp-heka-site-logo.png', __FILE__ ) ) );
		...
		class WPHEKA_Moneris {
			...
			public function plugin_row_meta( $links, $file ) {
				if ( plugin_basename( __FILE__ ) === $file ) {
					$row_meta = array(
						'donate'    => '<a href="' . esc_url( apply_filters( 'wpheka_gateway_moneris_donate_url', 'https://www.paypal.me/AKSHAYASWAROOP' ) ) . '" title="' . esc_attr( __( 'Donate', 'wpheka-gateway-moneris' ) ) . '">' . __( 'Donate', 'wpheka-gateway-moneris' ) . '</a>',
