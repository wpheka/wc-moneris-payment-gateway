...
class mpg_WOO_Moneris_Payment_Gateway extends WC_Payment_Gateway_CC {
	...
	public function process_payment($order_id) {
		...
		if ( empty( $_POST[$this->id.'-card-number'] ) ) {
			throw new Exception( __( 'Please enter your card number.', $MPG_Moneris_Payment_Gateway->text_domain ) );
		}

		if ( empty( $_POST[$this->id.'-card-expiry'] ) ) {
			throw new Exception( __( 'Please enter your card expiry.', $MPG_Moneris_Payment_Gateway->text_domain ) );
		}

		if ( empty( $_POST[$this->id.'-card-cvc'] ) ) {
			throw new Exception( __( 'Please enter your card cvc code.', $MPG_Moneris_Payment_Gateway->text_domain ) );
		}
