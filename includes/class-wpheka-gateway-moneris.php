					...
					<div id="side-sortables" class="meta-box-sortables ui-sortable">
						...
						<div class="inside">
							<div class="support-widget">
								<ul>
									<li>» Customers can save cards to their accounts for future purchases.</li>
									<li>» Supports eFraud tools / address and card verification.</li>
									<li>» Accepts Major Credit Cards / Debit Cards (Visa, MasterCard, Discover, JCB and American Express).</li>
									<li>» Process refunds automatically from within WooCommerce.</li>
									<li>» Option to directly charge credit cards or pre authorize credit cards transactions.</li>
									<li>» Dynamic descriptor option (Merchant defined description sent on a per-transaction basis that will appear on the credit card statement appended to the merchant’s business name).</li>
									<li>» Moneris Vault support for storing/removing credit card profiles.</li>
									<li>» Auto Hassle-Free Updates</li>
									<li>» High Priority Customer Support</li>
								</ul>
								<a href="https://www.wpheka.com/product/wc-moneris-payment-gateway-pro/" class="button" target="_blank"><span class="dashicons dashicons-star-filled" style="margin-top: 3px;"></span> Upgrade Now</a>
							</div>
						</div>
						</div>
						<div class="postbox ">
