...
class MPG_Moneris_Payment_Gateway_Config {
    ...
    private function define_constants() {
        ...
        if(!empty($plugin_data)) {
            ...
            $this->define( 'MPG_MONERIS_PAYMENT_GATEWAY_PLUGIN_NAME', $plugin_data['Name'] );
            $this->define( 'MPG_MONERIS_PAYMENT_GATEWAY_PLUGIN_ICON', plugins_url( '/assets/images/logo.png', __FILE__ ));
            $this->define( 'WPHEKA_MONERIS_PLUGIN_LOGO', plugins_url( '/assets/images/wp-heka-site-logo.png', __FILE__ ));
        }
    }
}
